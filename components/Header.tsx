...
const Header: React.FC<HeaderProps> = ({ activeScreen, onNavigateDownloads, onNavigateHome, onNavigateToPage, onOpenSignUpModal }) => {
    ...
    const socialLinks = [
        { name: 'Instagram', href: 'https://instagram.com/amarastelive', icon: InstagramIcon, className: 'instagram' },
        { name: 'SoundCloud', href: 'https://soundcloud.com/amarastelive', icon: SoundCloudIcon, className: 'soundcloud' },
        { name: 'Spotify', href: 'https://open.spotify.com/intl-pt/artist/3407XfslidAhQKTIaFW24m', icon: SpotifyIcon, className: 'spotify' },
        { name: 'YouTube', href: 'https://www.youtube.com/amarastelive', icon: YouTubeIcon, className: 'youtube' },
    ];
                ...
                <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative flex items-center justify-between h-24">
                        ...
                        <div className="flex items-center gap-4" ref={menuRef}>
                            {isBookerTheme && (
                               <>
                                   <a href="https://www.instagram.com/chamabruxaa" target="_blank" rel="noopener noreferrer" onClick={(e) => { applyClickAnimation(e); }} className="text-white p-2 transition-all duration-200 hover:bg-white/20 active:scale-95 booker-icon-glow" aria-label="Instagram">
                                       <InstagramIcon className="h-6 w-6" />
                                   </a>
                                   <a href="https://api.whatsapp.com/send/?phone=5575933002386&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" onClick={(e) => { applyClickAnimation(e); }} className="text-white p-2 transition-all duration-200 hover:bg-white/20 active:scale-95 booker-icon-glow" aria-label="Contato por WhatsApp">
                                       <PhoneIcon className="h-6 w-6" />
                                   </a>
                                   <a href="https://api.whatsapp.com/send/?phone=5575933002386&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" onClick={(e) => { applyClickAnimation(e); }} className="text-white p-2 transition-all duration-200 hover:bg-white/20 active:scale-95 booker-icon-glow" aria-label="Grupo de Membros">
