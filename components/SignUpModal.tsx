...
const SignUpModal: React.FC<SignUpModalProps> = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    // Simulate a form submission process that ends with an "unavailable" message.
    // This keeps the form visually functional but disables the actual registration.
    setTimeout(() => {
      setIsLoading(false);
      setError('O cadastro está indisponível no momento.');
    }, 800);
  };
