...
const ActionGrid: React.FC<ActionGridProps> = ({ onTalkAboutMusic, onOpenSignUpModal }) => {
    ...
    return (
        <div className="w-full flex items-stretch justify-center mt-6 home-buttons">
            {actionButtons.map(button => (
                <button
                  ...
                  className="btn red-white-btn flex-1 text-center text-2xl py-6 px-4 whitespace-nowrap trembling-button"
